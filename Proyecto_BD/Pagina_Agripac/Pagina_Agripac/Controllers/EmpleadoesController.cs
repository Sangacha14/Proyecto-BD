...
namespace Pagina_Agripac.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_empleado,id_cargo,idDepartamento,Nombre,Apellido,Correo")] Empleado empleado)
        {
            ...
            ViewBag.idDepartamento = new SelectList(db.Departamento, "idDepartamento", "Departamento1", empleado.idDepartamento);
            return View(empleado);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_empleado,id_cargo,idDepartamento,Nombre,Apellido,Correo")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
